...
// 6) 'Create Room Reservation' formundaki textbox'lar gorunur ve kullanilabilir olmali. Ardindan 'save' butonuna basilmali.
...
public class TC_0006 extends TestBaseFinal {
    ...
    public void tc_0006() {
        ...
        extentTest = extentReports.createTest("TC_0006 formdaki elementlerin kullanimi testi.", "'Create Room Reservation' formundaki textbox'larin kullanilabilirligi ve 'save' butonunun calisabilirligi.");
